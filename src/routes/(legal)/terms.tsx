      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="prose prose-invert max-w-none">
          <CardContent className="p-8">
            ...
            <p>
              By accessing or using EWF-ID ("the Service"), operated by
              Erstwähler Forum e.V. ("we", "us", "our"), you agree to be bound
            ...
            <p>
              EWF-ID is a centralized identity and authentication service for
              the Erstwähler Foundation ecosystem. It provides:
            </p>
            <ul>
              <li>Single Sign-On (SSO) authentication</li>
              <li>Account management</li>
              <li>
                Access to connected EWF applications (Schedule, Vote, Live,
                Screens)
              </li>
            ...
            <p>
              ...
              under 18, you represent that you have parental consent to use the
            ...
            <p>
              ...
              password and account. You must immediately notify us of any
              unauthorized use of your account. We recommend enabling two-factor
              authentication.
            </p>

            <h3 className="text-lg font-medium">4.3 One Account Per Person</h3>
            <p>
              Each person may only maintain one account. Multiple accounts may
            ...
            <p>
              If you link your account with a school identity provider, you
              acknowledge that:
            </p>
            <ul>
              <li>
                Your school may have policies governing your use of the Service
              </li>
              <li>
                We may share limited information with your school as required
              </li>
              <li>
                Your school affiliation may affect your access to certain
                features
              </li>
            </ul>
            ...
            <p>
              ...
              are owned by Erstwähler Forum e.V. and are protected by copyright,
              trademark, and other intellectual property laws.
            </p>

            <h2 className="text-xl font-semibold">8. User Content</h2>
            <p>
              You retain ownership of content you submit through the Service. By
              submitting content, you grant us a non-exclusive, worldwide,
              royalty-free license to use, display, and store such content for
            ...
            <p>
              You may delete your account at any time through the Privacy
              settings. Account deletion is subject to a 30-day grace period
              during which you may cancel the request.
            </p>

            <h3 className="text-lg font-medium">9.2 By Us</h3>
            <p>
              We may suspend or terminate your account at any time for violation
              of these Terms, illegal activity, or at our discretion. We will
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ERSTWÄHLER FORUM E.V.
            ...
            <p>
              You agree to indemnify and hold harmless Erstwähler Forum e.V.
            ...
            <p>
              ...
              shall be resolved in the courts of Stade, Germany, unless
            ...
            <p>
              ...
              <a
                href="mailto:legal@ewf-stade.de"
