      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="prose prose-invert max-w-none">
          <CardContent className="p-8">
            ...
            <p>
              EWF-ID uses cookies for the following purposes:
            </p>

            <h3 className="text-lg font-medium">Essential Cookies (Always Active)</h3>
            <p>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr>
                  <td><code>better_auth.session_token</code></td>
                  <td>Authentication session</td>
                  <td>7 days</td>
                </tr>
                <tr>
                  <td><code>__csrf</code></td>
            ...
            <h3 className="text-lg font-medium">Analytics Cookies (Optional)</h3>
            <p>
              These cookies help us understand how visitors interact with the website. 
              They are only set if you consent to analytics.
            </p>
            <table className="w-full">
              <thead>
                <tr>
            ...
            <ul>
              <li><strong>PostHog:</strong> Analytics and session replay (opt-in only)</li>
              <li><strong>Cloudflare:</strong> Security and CAPTCHA</li>
            </ul>
            <p>
              These services have their own privacy policies that govern their use of cookies.
            </p>

            <h2 className="text-xl font-semibold">Do Not Track</h2>
            <p>
              We respect the Do Not Track (DNT) browser setting. When DNT is enabled, we 
              automatically disable non-essential analytics cookies.
            </p>
