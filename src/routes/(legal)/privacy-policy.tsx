      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="prose prose-invert max-w-none">
          <CardContent className="p-8">
            ...
            <p>
              The data controller for EWF-ID is the Erstwähler Foundation (Erstwähler Forum e.V.), 
              registered in Stade, Germany.
            </p>
            <p>
            ...
            <ul>
              ...
              <li><strong>Profile Data:</strong> Display name, bio, profile picture, language preference</li>
              <li><strong>School Affiliation:</strong> School name, student ID (if linked via school SSO)</li>
              <li><strong>Authentication Data:</strong> Passkeys, 2FA settings</li>
              <li><strong>Session Data:</strong> IP addresses, user agent, login timestamps</li>
              <li><strong>Usage Data:</strong> Actions performed, pages visited (analytics)</li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>Service Provision:</strong> To provide EWF services (Schedule, Vote, Live, Screens)</li>
              <li><strong>Security:</strong> To detect and prevent fraud, unauthorized access, and abuse</li>
              <li><strong>Communication:</strong> To send security alerts and important notifications</li>
            ...
            <ul>
              <li><strong>Contract (Art. 6(1)(b)):</strong> Processing necessary to provide the service</li>
              <li><strong>Legitimate Interest (Art. 6(1)(f)):</strong> Security, fraud prevention, service improvement</li>
              <li><strong>Consent (Art. 6(1)(a)):</strong> Analytics cookies (when you opt-in)</li>
              <li><strong>Legal Obligation (Art. 6(1)(c)):</strong> Compliance with legal requirements</li>
            </ul>

            <h2 className="text-xl font-semibold">5. Data Retention</h2>
            <ul>
              <li><strong>Account Data:</strong> Retained until account deletion + 30 days grace period</li>
              <li><strong>Session Data:</strong> 90 days</li>
              <li><strong>Audit Logs:</strong> 2 years (anonymized after account deletion)</li>
            ...
            <ul>
              ...
              <li><strong>Right to Object (Art. 21):</strong> Opt-out of analytics processing</li>
              <li><strong>Right to Restrict (Art. 18):</strong> Request processing restrictions</li>
            </ul>
            <p>
            ...
            <h2 className="text-xl font-semibold">7. Data Processors (Subprocessors)</h2>
            ...
            <ul>
              <li><strong>Essential:</strong> Session cookies for authentication (always enabled)</li>
              <li><strong>Preferences:</strong> Language and theme preferences</li>
              <li><strong>Analytics:</strong> PostHog (only with your consent)</li>
            </ul>
            <p>
            ...
            <p>
              Your data may be transferred to countries outside the EU/EEA. We ensure appropriate 
              safeguards through Standard Contractual Clauses (SCCs) and only use processors that 
              are GDPR compliant.
            </p>
            ...
            <p>
              EWF-ID is intended for users aged 13 and older. We do not knowingly collect data 
            ...
            <p>
              ...
              In Germany, this is the Landesbeauftragte für Datenschutz Niedersachsen.
            </p>
          </CardContent>
        </Card>
      </div>
